...
export function BubbleTextIcon({ className }: IconProps) {
  return <ChatSvg className={`stroke-black ${className}`} />;
}

export function LinkedDotsIcon({ className }: IconProps) {
  return <IntegrationsSvg className={`stroke-black ${className}`} />;
}

export function SearchMenuIcon({ className }: IconProps) {
  return <SearchSvg className={`stroke-black ${className}`} />;
}

export function ActionsIcon({ className }: IconProps) {
  return <ActionsSvg className={`stroke-black ${className}`} />;
}

export function CodeIcon({ className }: IconProps) {
  return <CodeSvg className={`stroke-black ${className}`} />;
}

export function HeadsetMicIcon({ className }: IconProps) {
  return <HeadsetMicSvg className={`stroke-black ${className}`} />;
}

export function LineChartUpIcon({ className }: IconProps) {
  return <LineChartUpSvg className={`stroke-black ${className}`} />;
}

export function UsersIcon({ className }: IconProps) {
  return <UsersSvg className={`stroke-black ${className}`} />;
}

export function ActivityIcon({ className }: IconProps) {
  return <ActivitySvg className={`stroke-black ${className}`} />;
}

export function LockIcon({ className }: IconProps) {
  return <LockSvg className={`stroke-black ${className}`} />;
}

export function ServerIcon({ className }: IconProps) {
  return <ServerSvg className={`stroke-black ${className}`} />;
}

export function ShieldIcon({ className }: IconProps) {
  return <ShieldSvg className={`stroke-black ${className}`} />;
}

export function CloudIcon({ className }: IconProps) {
  return <CloudSvg className={`stroke-black ${className}`} />;
}

export function HardDriveIcon({ className }: IconProps) {
  return <HardDriveSvg className={`stroke-black ${className}`} />;
}

export function DevKitIcon({ className }: IconProps) {
  return <DevKitSvg className={`stroke-black ${className}`} />;
}

export function QuoteStartIcon({ className }: IconProps) {
  return <QuoteStartSvg className={`stroke-black ${className}`} />;
}

export function QuoteEndIcon({ className }: IconProps) {
  return <QuoteEndSvg className={`stroke-black ${className}`} />;
}

export function CpuIcon({ className }: IconProps) {
  return <CpuSvg className={`stroke-black ${className}`} />;
}

export function GlobeIcon({ className }: IconProps) {
  return <GlobeSvg className={`stroke-black ${className}`} />;
}

export function HourglassIcon({ className }: IconProps) {
  return <HourglassSvg className={`stroke-black ${className}`} />;
}

export function LightbulbSimpleIcon({ className }: IconProps) {
  return <LightbulbSimpleSvg className={`stroke-black ${className}`} />;
}

export function SidebarIcon({ className }: IconProps) {
  return <SidebarSvg className={`stroke-black ${className}`} />;
}

export function SlackIcon({ className }: IconProps) {
  return <SlackSvg className={`stroke-black ${className}`} />;
}

export function SparkleIcon({ className }: IconProps) {
  return <SparkleSvg className={`stroke-black ${className}`} />;
}

export function CheckCircleIcon({ className }: IconProps) {
  return <CheckCircleSvg className={`stroke-black ${className}`} />;
}

export function BarChartIcon({ className }: IconProps) {
  return <BarChartSvg className={`stroke-black ${className}`} />;
}

export function ImageIcon({ className }: IconProps) {
  return <ImageSvg className={`stroke-black ${className}`} />;
}

export function UserIcon({ className }: IconProps) {
  return <UserSvg className={`stroke-black ${className}`} />;
}

export function ClockIcon({ className }: IconProps) {
  return <ClockSvg className={`stroke-black ${className}`} />;
}

export function PieChartIcon({ className }: IconProps) {
  return <PieChartSvg className={`stroke-black ${className}`} />;
}

export function MenuIcon({ className }: IconProps) {
  return <MenuSvg className={`stroke-black ${className}`} />;
}

export function XIcon({ className }: IconProps) {
  return <XSvg className={`stroke-black ${className}`} />;
}

export function FileTextIcon({ className }: IconProps) {
  return <FileTextSvg className={`stroke-black ${className}`} />;
}

export function ArrowUpRightIcon({ className }: IconProps) {
  return <ArrowUpRightSvg className={`stroke-black ${className}`} />;
}
